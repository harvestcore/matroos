...
\begin{enumerate}
	\item Simplificar la creación de bots de \textit{Discord} de modo que estos sean fácilmente extensibles y configurables.
	...
	\item Facilitar la creación de comandos de \textit{Discord} de modo que estos sean sencillos de configurar, reutilizar y ampliar.
