...
\begin{itemize}
	\item  Diseñar y programar un sistema que sirva como capa de abstracción de la librería Discord.NET de C\# para crear bots y comandos de \textit{Discord}.
	\item  El sistema permitirá desplegar los bots de manera sencilla y agnóstica a la infraestructura subyacente.
