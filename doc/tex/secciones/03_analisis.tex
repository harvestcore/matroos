...
\begin{itemize}
	\item El programador, cuando se encuentra interactuando con otros usuarios en Discord, detecta una serie de funcionalidades (como enviar mensajes de alerta a todos los usuarios, o asignar un rol a cierto usuario) que sería interesante agregar al servidor. Accede al sistema y configura estas tareas en un bot, el cual agrega al servidor de Discord.
	\item El programador comprueba cada semana las necesidades que tienen los usuarios de los servidores de Discord donde ha agregado bots previamente. Si estas funcionalidades están obsoletas, las actualiza en el sistema; si son insuficientes agrega nuevas; y si ya no son necesarias las elimina.
